...
//panic，表示会导致整个程序出现崩溃的日志信息fatal，表示会导致当前这个请求出现提前终止的错误信息
...
const LogKey = "ping:log"

type LogLevel uint32

type NewLog func([]interface{}) (interface{}, error)
...
type CtxFielder func(interface{}) map[string]interface{}
